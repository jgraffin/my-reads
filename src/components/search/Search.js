...
class Search extends Component {
	...
	updateAdvancedQuery = (value) => {
		...
		if (match) {
			console.log('IF in updateAdvancedQuery')
			this.state.items.filter((item) => match.test(item.title))
	...
	resetQuery = () => {
		console.log('Here in resetQuery');
		this.setState({
			items: []
		})
	}
			...
			return (
				<div className="mr-search">
					<div className="container">
						...
						<Filter onUpdateQuery={(value) => value !== '' ? this.updateAdvancedQuery : this.resetQuery} />
